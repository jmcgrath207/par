...
//+kubebuilder:rbac:groups=proxy.par.dev,resources=httpproxies,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=proxy.par.dev,resources=httpproxies/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=proxy.par.dev,resources=httpproxies/finalizers,verbs=update
